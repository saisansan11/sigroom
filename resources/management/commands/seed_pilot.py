...
ROOMS = [
    ...
    # ห้องสอนออนไลน์ตามข้อมูลจริง: มี ~3 ห้องที่ บก.กศ.รร.ส.สส. (แผน V7 งาน B — seed สำหรับ dev/test เท่านั้น)
    ("STU-ONLINE-1", "ห้องสอนออนไลน์ 1", R.Type.ROOM, R.Category.ONLINE, "อาคาร บก.กศ.", "1", 5, "EDU", P.AUTO, 0, 15, "กล้อง\nไมโครโฟน\nไฟสตูดิโอ\nจอเขียว"),
    ("STU-ONLINE-2", "ห้องสอนออนไลน์ 2", R.Type.ROOM, R.Category.ONLINE, "อาคาร บก.กศ.", "1", 5, "EDU", P.AUTO, 0, 15, "กล้อง\nไมโครโฟน\nไฟสตูดิโอ\nจอเขียว"),
    ("STU-ONLINE-3", "ห้องสอนออนไลน์ 3", R.Type.ROOM, R.Category.ONLINE, "อาคาร บก.กศ.", "1", 5, "EDU", P.AUTO, 0, 15, "กล้อง\nไมโครโฟน\nไฟสตูดิโอ\nจอเขียว"),
